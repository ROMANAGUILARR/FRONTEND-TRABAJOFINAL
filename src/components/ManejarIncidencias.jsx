...
function leerIncidenciasDemo() {
  ...
  const mock = [
    { idIncidencia: 1, titulo: 'Acumulación y falta de recojo', descripcion: 'Basura acumulada en la esquina de Av. Principal con Jr. Los Olivos', estado: 'RESUELTO', fecha: '2026-09-10', direccionTexto: 'Av. Principal 123' },
    { idIncidencia: 2, titulo: 'Basura en vía pública', descripcion: 'Vertido de aguas residuales en el canal del barrio San Martin', estado: 'EN_PROCESO', fecha: '2026-09-11', direccionTexto: 'Jr. San Martin 456' },
    { idIncidencia: 3, titulo: 'Residuos en parques o áreas verdes', descripcion: 'Quema ilegal de basura en terreno baldio cerca del colegio', estado: 'PENDIENTE', fecha: '2026-09-12', direccionTexto: 'Calle Los Cedros 789' },
    { idIncidencia: 4, titulo: 'Contenedor dañado o lleno', descripcion: 'Arbol caido bloquea la vereda despues de temporal', estado: 'RESUELTO', fecha: '2026-09-13', direccionTexto: 'Av. Grau 321' },
    { idIncidencia: 5, titulo: 'Escombros o materiales de construcción', descripcion: 'Pequeno derrame de aceite en la pista principal', estado: 'EN_PROCESO', fecha: '2026-09-14', direccionTexto: 'Panamericana Sur km 15' },
    { idIncidencia: 6, titulo: 'Otro', descripcion: 'No hay papeleras en el parque del barrio Las Flores', estado: 'PENDIENTE', fecha: '2026-09-15', direccionTexto: 'Parque Las Flores' },
    { idIncidencia: 7, titulo: 'Acumulación y falta de recojo', descripcion: 'Basura acumulada frente al mercado municipal', estado: 'RESUELTO', fecha: '2026-09-16', direccionTexto: 'Mercado Municipal' },
    { idIncidencia: 8, titulo: 'Basura en vía pública', descripcion: 'Humo negro proveniente de fabrica textil', estado: 'EN_PROCESO', fecha: '2026-09-17', direccionTexto: 'Zona Industrial' },
    { idIncidencia: 9, titulo: 'Residuos en parques o áreas verdes', descripcion: 'Quema de hojas secas en via publica', estado: 'PENDIENTE', fecha: '2026-09-18', direccionTexto: 'Jr. Las Palmeras' },
    { idIncidencia: 10, titulo: 'Acumulación y falta de recojo', descripcion: 'Residuos abandonados en terreno', estado: 'PENDIENTE', fecha: '2026-09-19', direccionTexto: 'Av. Argentina' },
    { idIncidencia: 11, titulo: 'Basura en vía pública', descripcion: 'Agua turbia en acequia del barrio', estado: 'EN_PROCESO', fecha: '2026-09-20', direccionTexto: 'Jr. Los Pinos' },
    { idIncidencia: 12, titulo: 'Contenedor dañado o lleno', descripcion: 'Arbol caido sobre vehiculo estacionado', estado: 'RESUELTO', fecha: '2026-09-21', direccionTexto: 'Calle Los Olivos' },
    { idIncidencia: 13, titulo: 'Otro', descripcion: 'Sin papeleras en cuadra completa', estado: 'PENDIENTE', fecha: '2026-09-22', direccionTexto: 'Jr. Bolivar' },
    { idIncidencia: 14, titulo: 'Acumulación y falta de recojo', descripcion: 'Basura en parque central', estado: 'RESUELTO', fecha: '2026-09-23', direccionTexto: 'Parque Central' },
    { idIncidencia: 15, titulo: 'Basura en vía pública', descripcion: 'Aceite en desague del mercado', estado: 'EN_PROCESO', fecha: '2026-09-24', direccionTexto: 'Mercado Mayorista' },
    { idIncidencia: 16, titulo: 'Escombros o materiales de construcción', descripcion: 'Derrame menor en estacion de servicio', estado: 'PENDIENTE', fecha: '2026-09-25', direccionTexto: 'Av. Venezuela' },
    { idIncidencia: 17, titulo: 'Contenedor dañado o lleno', descripcion: 'Arbol bloquea la vereda despues del temporal', estado: 'RESUELTO', fecha: '2026-09-08', direccionTexto: 'Av. Grau 321' },
    { idIncidencia: 18, titulo: 'Otro', descripcion: 'No hay papeleras en el parque del barrio', estado: 'PENDIENTE', fecha: '2026-09-11', direccionTexto: 'Parque Las Flores' },
    { idIncidencia: 19, titulo: 'Escombros o materiales de construcción', descripcion: 'Derrame de aceite en la pista principal', estado: 'EN_PROCESO', fecha: '2026-09-07', direccionTexto: 'Panamericana Sur km 15' },
    { idIncidencia: 20, titulo: 'Acumulación y falta de recojo', descripcion: 'Basura frente al mercado municipal', estado: 'RESUELTO', fecha: '2026-09-09', direccionTexto: 'Mercado Municipal' },
    { idIncidencia: 21, titulo: 'Basura en vía pública', descripcion: 'Humo negro de fabrica textil', estado: 'EN_PROCESO', fecha: '2026-09-13', direccionTexto: 'Zona Industrial' },
    { idIncidencia: 22, titulo: 'Residuos en parques o áreas verdes', descripcion: 'Quema de hojas secas en via publica', estado: 'PENDIENTE', fecha: '2026-09-15', direccionTexto: 'Jr. Las Palmeras' },
    { idIncidencia: 23, titulo: 'Acumulación y falta de recojo', descripcion: 'Residuos en parque central', estado: 'RESUELTO', fecha: '2026-09-16', direccionTexto: 'Parque Central' },
    { idIncidencia: 24, titulo: 'Acumulación y falta de recojo', descripcion: 'Residuos abandonados en terreno baldio', estado: 'PENDIENTE', fecha: '2026-09-14', direccionTexto: 'Av. Argentina' },
    { idIncidencia: 25, titulo: 'Basura en vía pública', descripcion: 'Agua turbia en acequia del barrio', estado: 'EN_PROCESO', fecha: '2026-09-10', direccionTexto: 'Jr. Los Pinos' },
    { idIncidencia: 26, titulo: 'Contenedor dañado o lleno', descripcion: 'Arbol caido sobre vehiculo estacionado', estado: 'RESUELTO', fecha: '2026-09-12', direccionTexto: 'Calle Los Olivos' },
    { idIncidencia: 27, titulo: 'Otro', descripcion: 'Sin papeleras en parque', estado: 'PENDIENTE', fecha: '2026-09-14', direccionTexto: 'Parque Las Flores' },
    { idIncidencia: 28, titulo: 'Otro', descripcion: 'Sin papeleras en cuadra completa del centro', estado: 'PENDIENTE', fecha: '2026-09-13', direccionTexto: 'Jr. Bolivar' },
  ]
