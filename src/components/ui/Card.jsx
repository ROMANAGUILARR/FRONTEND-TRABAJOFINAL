const variants = {
  ...
  unlocked: 'bg-eco-bg-white border-eco-primary border-l-4 border-t border-r border-b',
  locked: 'bg-eco-bg-white border-eco-border border-l-4 border-l-gray-400 opacity-90',
