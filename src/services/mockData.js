...
export const MOCK_INSIGNIAS = [
  ...
  { idInsignia: 3, nombre: 'Guardian del barrio', descripcion: 'Has registrado 10 incidencias. Eres un referente ambiental.', requisitoIncidencias: 10, recompensa: 'Vale de S/100 en canasta familiar.', desbloqueada: true },
...
export const MOCK_USUARIOS = [
  { idUsuario: 1, nombreCompleto: 'Itzair', apellidoCompleto: 'Roman', dni: '72844283', telefono: '987654321', correoElectronico: 'itzairplus@gmail.com', nombreUsuario: 'GASPER', puntos: 100, rol: 'CIUDADANO', fechaRegistro: '2026-02-10' },
...
export const MOCK_INCIDENCIAS_POR_USUARIO = {
  1: [
    { id: 1, categoria: 'Acumulacion de basura', descripcion: 'Basura acumulada en la esquina de Av. Principal con Jr. Los Olivos', estado: 'RESUELTO', fecha: '2026-09-10', direccionTexto: 'Av. Principal 123', urlsImagenes: ['https://picsum.photos/seed/basura1/400/300', 'https://picsum.photos/seed/basura2/400/300'] },
    { id: 2, categoria: 'Contaminacion del agua', descripcion: 'Vertido de aguas residuales en el canal del barrio San Martin', estado: 'EN_PROCESO', fecha: '2026-09-11', direccionTexto: 'Jr. San Martin 456', urlsImagenes: ['https://picsum.photos/seed/agua1/400/300'] },
    { id: 3, categoria: 'Quema de residuos', descripcion: 'Quema ilegal de basura en terreno baldio cerca del colegio', estado: 'PENDIENTE', fecha: '2026-09-12', direccionTexto: 'Calle Los Cedros 789', urlsImagenes: ['https://picsum.photos/seed/querma1/400/300', 'https://picsum.photos/seed/querma2/400/300', 'https://picsum.photos/seed/querma3/400/300'] },
    { id: 4, categoria: 'Arbol caido', descripcion: 'Arbol caido bloquea la vereda despues de temporal', estado: 'RESUELTO', fecha: '2026-09-13', direccionTexto: 'Av. Grau 321', urlsImagenes: ['https://picsum.photos/seed/arbol1/400/300'] },
    { id: 5, categoria: 'Derrame de petroleo', descripcion: 'Pequeno derrame de aceite en la pista principal', estado: 'EN_PROCESO', fecha: '2026-09-14', direccionTexto: 'Panamericana Sur km 15', urlsImagenes: ['https://picsum.photos/seed/petroleo1/400/300', 'https://picsum.photos/seed/petroleo2/400/300'] },
    { id: 6, categoria: 'Falta de papelera', descripcion: 'No hay papeleras en el parque del barrio Las Flores', estado: 'PENDIENTE', fecha: '2026-09-15', direccionTexto: 'Parque Las Flores', urlsImagenes: ['https://picsum.photos/seed/papelera1/400/300'] },
    { id: 7, categoria: 'Acumulacion de basura', descripcion: 'Basura acumulada frente al mercado municipal', estado: 'RESUELTO', fecha: '2026-09-16', direccionTexto: 'Mercado Municipal', urlsImagenes: ['https://picsum.photos/seed/mercado1/400/300', 'https://picsum.photos/seed/mercado2/400/300'] },
    { id: 8, categoria: 'Contaminacion del aire', descripcion: 'Humo negro proveniente de fabrica textil', estado: 'EN_PROCESO', fecha: '2026-09-17', direccionTexto: 'Zona Industrial', urlsImagenes: ['https://picsum.photos/seed/humo1/400/300'] },
    { id: 9, categoria: 'Quema de residuos', descripcion: 'Quema de hojas secas en via publica', estado: 'PENDIENTE', fecha: '2026-09-18', direccionTexto: 'Jr. Las Palmeras', urlsImagenes: ['https://picsum.photos/seed/hojas1/400/300'] },
    { id: 10, categoria: 'Acumulacion de basura', descripcion: 'Residuos abandonados en terreno', estado: 'PENDIENTE', fecha: '2026-09-19', direccionTexto: 'Av. Argentina', urlsImagenes: ['https://picsum.photos/seed/terreno1/400/300', 'https://picsum.photos/seed/terreno2/400/300'] },
  ],
  2: [
